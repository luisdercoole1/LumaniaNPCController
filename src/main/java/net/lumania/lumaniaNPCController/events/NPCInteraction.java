...
/**
 * API-Klasse für NPC-Interaktionen.
 * Ermöglicht es anderen Plugins, NPC-Klick-Interaktionen zu registrieren.
 */
public class NPCInteraction {
    ...
    public static void registerInteraction(NPC npc, InteractionHandler handler) {
        ...
        Bukkit.getLogger().info("[NPCInteraction] Interaction für NPC '" + npc.getName() + "' (ID: " + entityId + ") registriert");
    }
    ...
    public static void registerInteraction(int entityId, InteractionHandler handler) {
        ...
        Bukkit.getLogger().info("[NPCInteraction] Interaction für Entity-ID " + entityId + " registriert");
    }
    ...
    public static void unregisterInteraction(NPC npc) {
        ...
        Bukkit.getLogger().info("[NPCInteraction] Interaction für NPC '" + npc.getName() + "' entfernt");
    }
    ...
    public static void unregisterInteraction(int entityId) {
        ...
        Bukkit.getLogger().info("[NPCInteraction] Interaction für Entity-ID " + entityId + " entfernt");
    }
    ...
    private static void registerPacketListener() {
        ...
        Bukkit.getLogger().info("[NPCInteraction] PacketListener registriert");
    }
    ...
    public static void clearAllInteractions() {
        ...
        Bukkit.getLogger().info("[NPCInteraction] Alle Interaktionen entfernt");
    }
}
